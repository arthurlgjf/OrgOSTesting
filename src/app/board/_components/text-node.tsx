...
function TextNodeComponent({ data, selected, id }: NodeProps<TextNodeType>) {
  ...
  const editingTextNodeId = useBoardStore((state) => state.editingTextNodeId);
  const setEditingTextNodeId = useBoardStore(
    (state) => state.setEditingTextNodeId,
  );
  const updateTextNodeContent = useBoardStore(
    (state) => state.updateTextNodeContent,
  );
  const updateTextNodeFontSize = useBoardStore(
