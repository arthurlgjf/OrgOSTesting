  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-foreground border-border/60 [a&]:hover:bg-accent [a&]:hover:text-accent-foreground [a&]:hover:border-accent-foreground/20",
        success:
          "border-transparent bg-emerald-500/90 text-white [a&]:hover:bg-emerald-500 dark:bg-emerald-600/80 dark:[a&]:hover:bg-emerald-600 shadow-sm",
        warning:
          "border-transparent bg-orange-500/90 text-white [a&]:hover:bg-orange-500 dark:bg-orange-600/80 dark:[a&]:hover:bg-orange-600 shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
